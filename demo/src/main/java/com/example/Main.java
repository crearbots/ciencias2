...
public class Main extends Application {
    ...
    // System.out.println("Se han cargado " + datos.productos.length + "
    // productos");
    ...
    // blockchain.agregarTransaccion("1", new Producto[]{datos.productos[100062],
    // datos.productos[100063]});
    // blockchain.agregarTransaccion("2", new Producto[]{datos.productos[100064]});
    // blockchain.agregarTransaccion("3", new Producto[]{datos.productos[100065],
    // datos.productos[100066]});
    ...
    // }
    // System.out.println("Tiempo de búsqueda: " + (endTimeId - startTimeId) + "
    // nanosegundos.");
    // break;
    ...
    // System.out.println("Producto no encontrado.");
    // }
    // System.out.println("Tiempo de búsqueda: " + (endTimeNombre - startTimeNombre)
    // + " nanosegundos.");
    // break;
    // case 4:
    // Arrays.sort(datos.productos, Comparator.comparing(p -> p.getNombre() == null
    // ? "" : p.getNombre()));
    // System.out.print("Ingrese el nombre del producto: ");
    // nombre = scanner.nextLine();
    // startTimeNombre = System.nanoTime();
